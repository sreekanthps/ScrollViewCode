...
class UpdateUserDetailsGpt: UIViewController {
    
    private let scrollView = UIScrollView()
    private let contentView = UIView()
    private let stackView = UIStackView()
    private var dateField: UITextField?   // to keep reference to DOB field
    ...
    private func setupScrollView() {
        ...
        NSLayoutConstraint.activate([
            ...
            // Important: match width for proper scrolling
    ...
    @objc private func dateIconTapped() {
        ...
        datePicker.maximumDate = Date() // restrict future DOB
